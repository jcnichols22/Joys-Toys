...
<head>
  ...
  <title>Joys Toys Checkout Page</title>
  <!-- css link -->
  ...
  <div class="container-fluid p-0">
    ...
    <div class="row px-2">
      ...
      <div class="col-md-12">
        ...
        <div class="row">
          <?php
          //if session variable username is not set then user is not logged in and will be redirected to user_login.php
          if (!isset($_SESSION['username'])) {
            // include user login form from user_login.php inside of checkout.php if user is not logged in
            include("user_login.php");
          } else {
            // include payment form from payment.php if user is logged in
            include("payment.php");
          }
          ?>
          <!-- row ends -->
